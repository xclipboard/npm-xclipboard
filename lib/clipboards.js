...
var createClipboard = function createClipboard(newClipboard, options, callback) {
  logger.debug('createClipboard: ', newClipboard);

  try {
    provider.createClipboard(newClipboard, function (err, clipboard) {
