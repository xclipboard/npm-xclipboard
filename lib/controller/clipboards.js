...
var ClipboardRequestBuilder = clipboardsModel.model.clipboardRequest.ClipboardRequestBuilder;
...
var buildResponse = function buildResponse() {
...
var getClipboardsV1 = function getClipboardsV1(req, res, next) {
  ...
  //  .map(function (item) {
  //    return buildClipboardResponse(clipboard);
  //  });
