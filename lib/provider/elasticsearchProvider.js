...
var provider = function provider(es, config) {
  ...
  var createClipboard = function createClipboard(newClipboard, callback) {
    logger.args('createClipboard: ', arguments);

    var clipboardId = newClipboard.id;

    es.create(clipboardId, newClipboard, config.elasticsearch.clipboards,
      function (error/*, result*/) {
        ...
        return callback(null, newClipboard);
      });
  };
